...
weight of its corresponding alignment. Note that, formally, $(S_a,P_a)$
and $(S_b,P_b)$ are parameters of the constraints but we omit them to
simplify notation.
...
subproblems independently of each other. In our setting, independent
